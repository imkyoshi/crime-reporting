...
require_once '../includes/report1_functions.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Retrieve form data
    $email = $_POST['email'];
    $formFileValidID  = handleFileUpload('formFileValidID', __DIR__.'../dist/uploads/valid_ids/');
    ...
    $formFileEvidence = handleFileUpload('formFileEvidence', __DIR__. '../dist/uploads/evidences/');
    ...
    <div class="content-wrapper" id="login">
        <div class="container p-5">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-10">
                    <div class="card">
                        <form method="POST" action="../view/report2.php">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="label-wrapper">
                                            <input class="form-control" type="file" id="formFileValidID" name="formFileValidID" multiple
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="placeOfIncident" name="placeOfIncident" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-md" id="exampleTextarea" name="statement" rows="6"
                                    ...
                                    <!-- <div class="col-md-12">
                                       ...
                                       <div class="form-group">
                                        <?php echo '<img src="'.$imageData.'" class="" name="qrcode" alt="" style="width:150px;">'; ?>
                                        <button type="button" class="btn btn-primary" id="qrBtn" name="qrBtn">Generate QR Code</button>
                                       </div>
                                   </div> -->
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="label-wrapper">
                                            <input class="form-control" type="file" id="formFileEvidence" name="formFileEvidence" multiple
